...
# From this file you generally only need:
#
# - random_bus_forecast () -> Float[0, 1]
#     gives you a values between 1 and 0 representing the percantage of the maximum load seen on this system
#     it picks the forecast by picking a random hour of the year and looking up that value in the table.
#
# - actual_load2 (Float[0, 1]) -> Float([~0, ~1])
#     This takes the output to `random_bus_forecast` and gives you a sample of what the actual value could be
#     It does this by returning a normally distributed random number with a mean of the input and a S.D of 0.05.
#
# - quantised_01(Float) -> Float
#     Rounds a number to the nearest 0.01
#
# - quantised_05(Float) -> Float
