...
def read(infile):
    ...
    for row in csv.reader(infile):
        ...
        if readinfo != None:
            ...
            components[name] = (probability_failure(failrate), probability_outage(mttf, mttr))
...
#         probability ::= (real(0, 1), real(0, 1))
#
# this is the join slowest function of the program, # along with running the load flow program
...
class Tester_Sample_Failures(ModifiedTestCase):
    ...
    def test_c(self):
        ...
        rnd = Generate_rnd_sequence([0.28, 0.72, 0.96, 0.37, 0.08, 0.65, 0.05, 0.36, 0.00, 0.66])
